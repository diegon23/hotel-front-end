...
<div class="tab-pane fade show active" id="nav-tab-card">
	<form role="form" method="POST" action = "../operacoes/FinalizarReserva.php">
	...
	<div class="row">
	    <div class="col-sm-8">
	        <div class="form-group">
	        	...
	        	<div class="input-group">
	        		<input type="text" maxlength="2" class="form-control" placeholder="MM" name="">
		            <input type="text" maxlength="2" class="form-control" placeholder="YY" name="">
	        	</div>
	        </div>
	    </div>
	    <div class="col-sm-4">
	        <div class="form-group">
	            ...
	            <input maxlength="3" type="text" class="form-control" required="">
	        </div>
	    </div>
	</div>
